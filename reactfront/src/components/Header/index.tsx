...
import { DoctorFilter } from '../../types/user';
...
const Header = (props: {
  ...
  const [searchResult, setSearchResult] = useState<DoctorFilter[]>();
  ...
  const apiCall = (content: string = searchContent) => {
    let data = {
      ...
      <div className="flex flex-grow items-center justify-between px-4 py-4 shadow-2 md:px-6 2xl:px-11">
        ...
        <div className="hidden sm:block">
          <form action="https://formbold.com/s/unique_form_id" method="POST">
            <div className="relative flex items-center dark:bg-form-input">
              <div>
                ...
                <div className='absolute bg-red-600 w-full dark:bg-form-input'>
                  {searchResult?.map(item =>
                    <div className='dark:bg-meta-3 text-white p-3 mt-3'>
              ...
              <div>
                <SelectGroupOne selectedOption={city} setSelectedOption={setCity} data={cities} />
              </div>
            </div>
          </form>
