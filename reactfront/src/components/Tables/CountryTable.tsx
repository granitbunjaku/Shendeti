...
const CountryTable = () => {
  ...
  const handleDeletion = (id: number) => {  
    axios.delete(`http://localhost:5095/Country/id?id=${id}`)
      .then(res => { dispatch(getAllCountries()); })
              ...
              <tr key={key}>
                ...
                <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                  <div className="flex items-center space-x-3.5">
                    ...
                    <Link to={`/edit/${id}`} className="hover:text-meta-3">
