...
import { getMyUser, login, resetError } from '../../slices/userSlice';
...
const SignIn: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (!password.trim() || password.trim().length <= 5) {
      setPasswordError('Fjalekalimi duhet te jete i gjate 6+ karaktere');
      return;
    }
  ...
  return (
    <div className='w-full dark:bg-boxdark bg-white p-4 md:p-6 2xl:p-10 h-screen flex flex-col justify-center items-center gap-6'>
    <DarkModeSwitcher />
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="mt-6 text-center">
                  <p>
                    ...
                    <Link to="/auth/signup" className="text-meta-3">
                      Sign Up
                    </Link>
                  </p>
                </div>
                <p className='text-red-700 text-center mt-5'>{emailError}</p>
                <p className='text-red-700 text-center mt-5'>{passwordError}</p>
